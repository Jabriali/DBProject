...
<div class="container-fluid <?php echo $template['blog_sfondo']?> <?php echo $template['blog_colorefont']?>">
    <div class="blog-info d-flex flex-column align-items-center"> 
        ...
        <?php if($autore):?>    
            <a href="../post/nuovo_post.php?id=<?php echo $blog['blog_id']?>&autore=<?php echo $_SESSION['loggato']?>" class="btn btn-dark">Nuovo post</a>
        <?php endif ?>
    </div>

    <div class="mt-4 d-flex flex-row flex-wrap justify-content-left">
        <?php foreach ($posts as $i => $post) :?>
            <div class="card <?php echo $template['blog_sfondo']?> border border-dark mt-2 mb-5 me-5 ms-5 w-25">
                ...
                <div class="card-body">
                    ...
                    <a class="btn btn-dark" href="../post/post.php?id=<?php echo $post['post_id']?>">Visualizza</a>
                </div>
